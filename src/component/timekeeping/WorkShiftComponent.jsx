...
import CreateShiftComponent from './crud/CreateShiftComponent';
import ContextMenuWorkShift from '../../contextmenu/ContextMenuWorkShift';
...
const WorkShiftComponent = () => {
    ...
    return (
        <>
                    ...
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3 p-categoty-list">
                            <div className='d-flex category-list-employ' style={{ gap: '20px', fontSize: '14px', fontWeight: 500 }}>
                                ...
                                <span>Phân ca phòng ban, vị trí</span>
            ...
            <ContextMenuWorkShift x={x} y={y} showMenu={showMenu} />
