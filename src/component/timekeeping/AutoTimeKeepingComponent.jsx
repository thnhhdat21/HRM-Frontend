...
const AutoTimeKeepingComponent = () => {
    ...
    return (
        <>
                    ...
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3 p-categoty-list">
                            ...
                            <div class="mb-2 dropdown profile-dropdown">
                                <a href="#" class="btn btn-danger d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#crud_auto_timekeeping" >
            ...
            <ContextMenuAutoTime x={x} y={y} showMenu={showMenu} />
            <AutoTimeKeepingCRUDComponent />
        </>
    );
};

export default AutoTimeKeepingComponent;
