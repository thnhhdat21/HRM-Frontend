...
const EmployeeReceiveComponent = () => {
    return (
        <>
            <div class="mt-5 tab-pane fade " id="profile-receive">
                <div class="profile-container">
                    <div class="profile-header">Thủ tục tiếp nhận</div>
...
export default EmployeeReceiveComponent;
