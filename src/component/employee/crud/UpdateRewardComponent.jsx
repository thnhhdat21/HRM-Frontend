...
const UpdateRewardComponent = () => {
    return (
        <>
            <div class="modal fade" id="update_reward">
                <div class="modal-dialog modal-dialog-centered modal-lg modal-edit-account">
                    <div class="modal-content">
                        <div class="modal-header">
                            <div class="d-flex align-items-center">
                                <h4 class="modal-title me-2">Chế độ phúc lợi</h4>
                            </div>
                                ...
                                <div class="tab-pane fade show active">
                                    <div class="modal-body pb-0 ">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <label class="form-label">Tên phúc lợi</label>
...
export default UpdateRewardComponent;
