        ...
        if (typeOpen.at(-1) === TYPE_CREATE_APPDIX) {
            const fetchAll = async () => {
                ...
                if (response.data.code === 1000) {
                    ...
                    const responseDetail = await countContractAppendix(contractProfile.contractId)
                    if (responseDetail.data.code === 1000) {
                        const count = responseDetail.data.data
                        setContractDetail({
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <div class="d-flex align-items-center">
                                <h4 class="modal-title me-2">{typeOpen.at(-1) === TYPE_CREATE_NEW ? "Tạo mới hợp đồng" : "Thêm phụ lục hợp đồng"}</h4>
                            </div>
