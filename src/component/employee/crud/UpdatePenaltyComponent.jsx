...
const UpdatePenaltyComponent = () => {
    return (
        <>
            <div class="modal fade" id="update_penalty">
                <div class="modal-dialog modal-dialog-centered modal-lg modal-edit-account">
                    <div class="modal-content">
                        <div class="modal-header">
                            <div class="d-flex align-items-center">
                                <h4 class="modal-title me-2">Kỷ luật nội bộ</h4>
                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="date" class="form-control" placeholder='Nhập tên chức vụ' />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="mb-3">
                                                    <label class="form-label">Hình thức phạt</label>
...
export default UpdatePenaltyComponent;
