...
import AppendixCRUDComponent from './crud/AppendixCRUDComponent';
                ...
                <div class="content">
                    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
                        <div class="my-auto mb-2">
                            <h2 class="mb-1">Loại hợp đồng</h2>
                        </div>
                        <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                            ...
                            <div class="mb-2">
                                <Link to={"/manage-employee/create-contract"}
                                    class="btn btn-primary d-flex align-items-center"><i
                                        class="ti ti-circle-plus"></i></Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3 p-categoty-list">
                            <div className='d-flex category-list-employ' style={{ gap: '20px', fontSize: '14px', fontWeight: 500 }}>
                                ...
                                <span>Hợp đồng(23)</span>
                                <span>Hợp đồng 6 tháng(23)</span>
                                <span>Hợp đồng 1 năm (60)</span>
                                <span>Hợp đồng 2 năm (60)</span>
                            </div>
