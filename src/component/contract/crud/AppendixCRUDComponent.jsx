...
const AppendixCRUDComponent = () => {
    return (
        <>
            <div class="modal fade" id="create_appendix">
                <div class="modal-dialog modal-dialog-centered modal-lg modal-crud-appendix">
                    <div class="modal-content">
                        <div class="modal-header">
                            <div class="d-flex align-items-center">
                                <h4 class="modal-title me-2">Thêm phụ lục hợp đồng</h4>
                            </div>
...
export default AppendixCRUDComponent;
