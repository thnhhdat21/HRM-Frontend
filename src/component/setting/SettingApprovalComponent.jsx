...
import ReasonEndJobCRUDComponent from './crud/approval/ReasonEndJobCRUDComponent';
...
const SettingApprovalComponent = () => {
    ...
    return (
        <>
                                ...
                                <div class="dropdown-menu shadow-none">
                                    <div class="card mb-0">
                                        <div class="card-body crud-depart">
                                            <a class="dropdown-item d-inline-flex align-items-center p-0 py-2" data-bs-toggle="modal" data-bs-target="#create_leave_reason" >
                                                Đơn xin nghỉ
                                            </a>
                                            ...
                                            <a class="dropdown-item d-inline-flex align-items-center p-0 py-2" data-bs-toggle="modal" data-bs-target="#crud_worktime_reason" >
                                                Đơn làm theo chế độ
                                            </a>
                                            ...
                                            <a class="dropdown-item d-inline-flex align-items-center p-0 py-2" data-bs-toggle="modal" data-bs-target="#crud_endjob_reason" >
                                                Đơn thôi việc
                                            </a>
                                        </div>
                                    </div>
                    ...
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3 p-categoty-list">
                            <div className='d-flex category-list-employ' style={{ gap: '20px', fontSize: '14px', fontWeight: 500 }}>
                                <span className='active-category-list'>Lý do xin nghỉ</span>
                                <span>Lý do OT</span>
                                <span>Lý do làm theo chế độ</span>
                                <span>Lý do checkin/out</span>
                                <span>Lý do công tác</span>
                                <span>Lý do thôi việc</span>
                            </div>
                        </div>
            ...
            <ReasonLeaveCRUDComponent />
            <ReasonWorktimeCRUDComponent />
            <ReasonEndJobCRUDComponent />
        </>
    );
};
