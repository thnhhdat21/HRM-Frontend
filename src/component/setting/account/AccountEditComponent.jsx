                            ...
                            <div className="tab-content" id="myTabContent">
                                <div className="tab-pane fade show active">
                                    <div className="modal-body pb-0 ">
                                        <div className="row">
                                            <div className="col-md-8">
                                                <div className="mb-3">
                                                    <label className="form-label">Hồ sơ nhân sự</label>
                                                    <input type="email" className="form-control readonly-input" value={accountDetail && accountDetail.name} />
                                                </div>
                                            </div>
                                            <div className="col-md-4">
                                                <div className="mb-3">
                                                    <label className="form-label">Tài khoản</label>
                                                    <input type="email" className="form-control  readonly-input" value={accountDetail && accountDetail.username} />
                                                </div>
                                            </div>
                                            <div className="col-md-12">
                                                <div className="mb-3">
                                                    <label className="form-label">Phòng ban <span className="text-danger">
                                                        *</span></label>
                                                    <input type="text" className="form-control  readonly-input" value={accountDetail && accountDetail.department} />
                                                </div>
                                            </div>
                                            <div className="col-md-8">
                                                <div className="mb-3">
                                                    <label className="form-label">Email</label>
                                                    <input type="text" className="form-control readonly-input" value={accountDetail && accountDetail.email} />
                                                </div>
                                            </div>
                                            ...
                                            <div className="col-md-4">
                                                <div className="mb-3">
                                                    ...
                                                    <input type="text" className="form-control readonly-input" value={accountDetail && accountDetail.dateOfBirth} />
                                            ...
                                            <div className="col-md-6">
                                                <div className="mb-3">
                                                    ...
                                                    <input type="text" className="form-control readonly-input" value={accountDetail && accountDetail.phoneNumber} />
                                            ...
                                            <div className="col-md-6">
                                                <div className="mb-3">
                                                    <label className="form-label">Trạng thái <span className="text-danger">
                                                        *</span></label>
                                                    <input type="text" className="form-control readonly-input" value={accountDetail && getStatus(accountDetail.status)} />
                                                </div>
                                            </div>
                                            <div className='checkbox-permisstion'>
                                                <input className="form-check-input" type="checkbox" checked={checkChangePass} style={{ width: "18.4px", height: "18.4px" }} onChange={() => setCheckChangePass(!checkChangePass)} />
                                                <span style={{ marginLeft: "20px" }}>Thay đổi mật khẩu</span>
                                            </div>
                                            <div className={`row permission-row  ${!checkChangePass ? "blurred" : ""}`}>
                                                <div className="col-md-6">
                                                    <div className="mb-3">
                                                        <label className="form-label">Mật khẩu <span className="text-danger">
                                                            *</span></label>
                                                        <input type="text" className="form-control" name='password' onChange={onChangeInput} value={values.password || ""} />
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                    <div className="mb-3">
                                                        <label className="form-label">Xác nhận lại mật khẩu <span className="text-danger">
                                                            *</span></label>
                                                        <input type="text" className="form-control" name='rePassword' onChange={onChangeInput} value={values.rePassword || ""} />
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-md-12">
                                                <div className="mb-3">
                                                    <label className="form-label">Nhóm người dùng <span className="text-danger">
                                                        *</span></label>
                                            ...
                                            <div className='checkbox-permisstion'>
                                                <input className="form-check-input" type="checkbox" style={{ width: "18.4px", height: "18.4px" }} checked={checkChangePermission} onChange={() => setCheckChangePermission(!checkChangePermission)} />
                                    ...
                                    <div className="modal-footer">
                                        ...
                                        <div type="submit" className="btn btn-primary" onClick={handleSubmitClick}>CẬP NHẬT</div>
                                    </div>
                                </div>
                            </div>
                        </form>
