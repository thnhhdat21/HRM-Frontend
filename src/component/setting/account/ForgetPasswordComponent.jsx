...
import { changePassword } from '../../../service/Manage/ManageAccountService';


const ForgetPasswordComponent = ({ selected }) => {
    ...
    const handleClickActive = () => {
        ...
        changePassword(selected.id, passwordActive).then((response) => {
            if (response.data.code === 1000) {
                toast.success("Đổi mật khẩu thành công");
                document.querySelector('#forget_password [data-bs-dismiss="modal"]').click();
    ...
    return (
        <>
            <div className="modal fade" id="forget_password">
                <div className="modal-dialog modal-dialog-centered modal-lg">
                    <div className="modal-content">
                        <div className="modal-header">
                            <div className="d-flex align-items-center">
                                <h4 className="modal-title me-2">Quên mật khẩu</h4>
                            </div>
                                            ...
                                            <div className="col-md-12">
                                                <div className="mb-3">
                                                    <label className="form-label">Mật khẩu <span className="text-danger">
                                                        *</span></label>
                                                    <input name='password' onChange={onChangeInput} type="text" className="form-control" />
                                                </div>
                                            </div>
                                            <div className="col-md-12">
                                                <div className="mb-3">
                                                    <label className="form-label">Xác nhận lại mật khẩu <span className="text-danger">
                                                        *</span></label>
                                                    <input name='rePassword' onChange={onChangeInput} type="text" className="form-control" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
