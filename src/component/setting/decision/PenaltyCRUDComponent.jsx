...
const PenaltyCRUDComponent = ({ selected, typeOpen, setListPenalty }) => {
    ...
    return (
        <>
            <div className="modal fade" id="crud_penalty">
                <div className="modal-dialog modal-dialog-centered modal-lg modal-edit-account">
                    <div className="modal-content">
                        <div className="modal-header">
                            <div className="d-flex align-items-center">
                                <h4 className="modal-title me-2">{typeOpen.at(-1) === modalEdit ? "Chỉnh sửa" : "Tạo mới"} hình phạt</h4>
                            </div>
                            ...
                            <div className="tab-content" id="myTabContent">
                                <div className="tab-pane fade show active">
                                                            ...
                                                            <div className="mb-3">
                                                                <table className="table table-add table-leave">
                                                                    ...
                                                                    <tbody>
                                                                        {rows.map((row, index) => (
                                                                            <tr key={row.id}>
                                                                                <td><input placeholder='Tên phạt nội bộ...' type="text" className="form-control" name='name' value={row.name} onChange={(e) => onChangeInputCreate(index, e)} /></td>
                                    ...
                                    <div className="modal-footer">
                                        ...
                                        <div type="submit" className="btn btn-primary" onClick={typeOpen.at(-1) === modalEdit ? handleUpdatePenalty : handleCreatePenalty} > {typeOpen.at(-1) === modalEdit ? "CẬP NHẬT" : "THÊM MỚI"}</div>                                    </div>
                                </div>
                            </div>
                        </form>
                    </div>
