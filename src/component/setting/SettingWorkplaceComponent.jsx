...
const SettingWorkplaceComponent = () => {
    return (
        <>
                    ...
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3 p-categoty-list">
                            <div className='d-flex' style={{ gap: '20px', fontSize: '14px', fontWeight: "500" }}>
                                <span className='active-category-list'>Nơi làm việc </span>
                            </div>
                        </div>
                                    ...
                                    <table class="table" id='myTable'>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><span>222 Hoàng Hoa Thám, Phường 12, Quận Tân Bình, TP HCM</span></td>
...
export default SettingWorkplaceComponent;
