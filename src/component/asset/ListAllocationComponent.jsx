...
const ListAllocationComponent = () => {
    ...
    return (
        <>
                    ...
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3 p-categoty-list">
                            <div className='d-flex category-list-employ' style={{ gap: '20px', fontSize: '14px', fontWeight: 500 }}>
                                ...
                                <span>Thu hồi xong</span>
                                <span>Điều chuyển</span>
                            </div>
                            <div class="mb-2 dropdown profile-dropdown">
                                <a href="#" class="btn btn-danger d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#crud_allocation" >
            ...
            <AllocationDetailComponent x={xdb} y={ydb} showMenu={showMenudb} />
            <ContextMenuAllocation x={x} y={y} showMenu={showMenu} />
            <AllocationCRUDComponent />
        </>
    );
};

export default ListAllocationComponent;
