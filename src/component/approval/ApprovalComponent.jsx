...
import LeaveApprovalComponent from './crud/LeaveApprovalComponent';
import CheckinApprovalComponent from './crud/CheckinApprovalComponent';
import JobApprovalComponent from './crud/JobApprovalComponent';
import OvertimeApprovalComponent from './crud/OvertimeApprovalComponent';
import WorkTimeApprovalComponent from './crud/WorkTimeApprovalComponent';
import EndJobApprovalComponent from './crud/EndJobApprovalComponent';
const ApprovalComponent = () => {
    ...
    return (
        <>
                ...
                <div class="content">
                    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
                        <div class="my-auto mb-2">
                            <h2 class="mb-1">Danh sách đơn từ</h2>
                        </div>
                                ...
                                <div class="dropdown-menu shadow-none">
                                    <div class="card mb-0">
                                        <div class="card-body crud-depart">
                                            <a class="dropdown-item d-inline-flex align-items-center p-0 py-2" data-bs-toggle="modal" data-bs-target="#create_leave_approval" >
                                                Đơn xin nghỉ
                                            </a>
                                            <a class="dropdown-item d-inline-flex align-items-center p-0 py-2" data-bs-toggle="modal" data-bs-target="#create_overtime_approval">
                                                Đơn đăng ký OT
                                            </a>
                                            <a class="dropdown-item d-inline-flex align-items-center p-0 py-2" data-bs-toggle="modal" data-bs-target="#create_worktime_approval" >
                                                Đơn làm theo chế độ
                                            </a>
                                            <a class="dropdown-item d-inline-flex align-items-center p-0 py-2" data-bs-toggle="modal" data-bs-target="#create_checkin_approval" >
                                                Giải trình đi muộn về sớm
                                            </a>
                                            <a class="dropdown-item d-inline-flex align-items-center p-0 py-2" data-bs-toggle="modal" data-bs-target="#create_job_approval" >
                                                Đơn đi công tác
                                            </a>
                                            <a class="dropdown-item d-inline-flex align-items-center p-0 py-2" data-bs-toggle="modal" data-bs-target="#create_endjob_approval" >
                                                Đơn thôi việc
                                            </a>
                                        </div>
                                    </div>
                    ...
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3 p-categoty-list">
                            <div className='d-flex category-list-employ' style={{ gap: '20px', fontSize: '14px', fontWeight: 500 }}>
                                <span className='active-category-list'>Tất cả (209)</span>
                                <span>Chờ duyệt(23)</span>
                                <span>Đã duyệt(23)</span>
                                <span>Không duyệt(60)</span>
                            </div>
            ...
            <WorkTimeApprovalComponent />
            <EndJobApprovalComponent />
        </>
    );
};
