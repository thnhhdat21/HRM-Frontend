                    ...
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3 p-categoty-list">
                            ...
                            <div class="mb-2 dropdown profile-dropdown">
                                <Link to={"/manage-salary/create-payroll-type"} class="btn btn-danger d-flex align-items-center" >
                                    ...
                                    <table ref={tableRef} class="table" id='myTable'>
                                        <thead class="thead-light">
                                            <tr>
                                                ...
                                                <th>Người tạo</th>
                                                <th>Mã loại bảng lương</th>
                                                <th>Tên bảng lương</th>
                                                <th>Từ khóa đại diện</th>
...
export default PayrollTypeComponent;
