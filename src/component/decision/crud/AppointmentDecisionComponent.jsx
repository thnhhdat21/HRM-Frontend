...
const AppointmentDecisionComponent = () => {
    return (
        <>
            <div class="modal fade" id="create_appointment_decision">
                <div class="modal-dialog modal-dialog-centered modal-lg ">
                    <div class="modal-content">
                        <div class="modal-header">
                            <div class="d-flex align-items-center">
                                <h4 class="modal-title me-2">Quyết định bổ nhiệm</h4>
                            </div>
                        ...
                        <div class="modal-body test">
                            ...
                            <div class="row mt-2">
                                <div class="col-md-8">
                                    <div class="mb-3">
                                        <label class="form-label">Lý do bổ nhiệm </label>
                                        <input type="email" class="form-control" placeholder='Nhập tên chức vụ' />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label">Phòng ban bổ nhiệm </label>
                                        <input type="email" class="form-control" placeholder='Nhập tên chức vụ' />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label">Vị trí bổ nhiệm </label>
                                        <input type="email" class="form-control" placeholder='Nhập tên chức vụ' />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label">Chức vụ bổ nhiệm </label>
                                        <input type="email" class="form-control" placeholder='Nhập tên chức vụ' />
                                    </div>
                                </div>
                            </div>
...
export default AppointmentDecisionComponent;
