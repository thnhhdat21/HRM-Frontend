                            ...
                            <div class="col-md-9">
                                <div class="mb-3">
                                    ...
                                    <select className="form-control">
                                        <option value="" selected hidden>Chọn Quyết định</option>
                                        <option value="Cha">Quyết định khen thưởng</option>
                                        <option value="Mẹ">Quyết dịnh điều chuyển</option>
                                        <option value="Anh trai">Quyết định kỷ luật lao động</option>
                                        <option value="Chị gái">Quyết định miễn nhiệm</option>
                                        <option value="Con">Quyết định bộ nhiểm</option>
                                        <option value="Con">Quyết định tiếp nhận</option>
                                        <option value="Con">Quyết định điều chỉnh lương</option>
                                        <option value="Con">Quyết định chấm dứt HĐLĐ</option>
                                    </select>
