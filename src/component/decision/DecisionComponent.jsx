...
import RewardDecisionComponent from './crud/RewardDecisionComponent';
import TranferDecisionComponent from './crud/TranferDecisionComponent';
import SalaryDecisionComponent from './crud/SalaryDecisionComponent';
import PenaltyDecisionComponent from './crud/PenaltyDecisionComponent';
import AppointmentDecisionComponent from './crud/AppointmentDecisionComponent';
...
const DecisionComponent = () => {
    ...
    return (
        <>
                ...
                <div class="content">
                    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
                        <div class="my-auto mb-2">
                            <h2 class="mb-1">Danh sách quyết định</h2>
                        </div>
                                ...
                                <div class="dropdown-menu shadow-none">
                                    <div class="card mb-0">
                                        <div class="card-body crud-depart">
                                            <a class="dropdown-item d-inline-flex align-items-center p-0 py-2" data-bs-toggle="modal" data-bs-target="#create_reward_decision" >
                                                Quyết định khen thưởng
                                            </a>
                                            <a class="dropdown-item d-inline-flex align-items-center p-0 py-2" data-bs-toggle="modal" data-bs-target="#create_tranfer_decision">
                                                Quyết định điều chuyển
                                            </a>
                                            <a class="dropdown-item d-inline-flex align-items-center p-0 py-2" data-bs-toggle="modal" data-bs-target="#create_penalty_decision" >
                                                Quyết định Kỷ luật lao động
                                            </a>
                                            <a class="dropdown-item d-inline-flex align-items-center p-0 py-2" data-bs-toggle="modal" data-bs-target="#create_appointment_decision" >
                                                Quyết định bổ nhiệm
                                            </a>
                                            <a class="dropdown-item d-inline-flex align-items-center p-0 py-2" data-bs-toggle="modal" data-bs-target="#create_salary_decision" >
                                                Quyết định điều chỉnh lương
                                            </a>
                                            <a class="dropdown-item d-inline-flex align-items-center p-0 py-2 border-bottom" data-bs-toggle="modal" data-bs-target="#create_endcontract_decision">
            ...
            <PenaltyDecisionComponent />
            <AppointmentDecisionComponent />
