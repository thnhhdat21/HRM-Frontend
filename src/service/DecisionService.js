...
const REST_API_BASE_URL = "/manage-decision";
...
export const getListDecision = (values) => {
    ...
    return axiosClient.post(`${REST_API_BASE_URL}/get-list-decision`, requestBody)
}
...
export const getCountDecision = (values) => {
    ...
    return axiosClient.post(`${REST_API_BASE_URL}/count-decision`, requestBody)
}
...
export const deleteDecision = (decisionId) => {
    ...
    return axiosClient.post(`${REST_API_BASE_URL}/delete-decision`, formData)
}
...
export const updateRewardAndPenalty = (values) => {
    ...
    return axiosClient.post(`${REST_API_BASE_URL}/reward-and-penalty-decision`, requestBody)
}
...
export const updateTransferAndAppoint = (values) => {
    ...
    return axiosClient.post(`${REST_API_BASE_URL}/transfer-and-appointment-decision`, requestBody)
}
...
export const updateTerminationDecision = (values) => {
    ...
    return axiosClient.post(`${REST_API_BASE_URL}/termination-decision`, requestBody)
}
...
export const updateSalaryAppoint = (values, allowances) => {
    ...
    return axiosClient.post(`${REST_API_BASE_URL}/salary-decision`, requestBody)
}

export const getDecision = (decisionId) => {
    const formData = new FormData();
    formData.append("decisionId", decisionId)
    return axiosClient.post(`${REST_API_BASE_URL}/get-decision-by-id`, formData)
}
...
export const noApprovalDecision = (decisionId) => {
    const formData = new FormData();
    formData.append("decisionId", decisionId)
    return axiosClient.post(`${REST_API_BASE_URL}/no-approve-decision`, formData)
}

export const approvalDecision = (decisionId) => {
    const formData = new FormData();
    formData.append("decisionId", decisionId)
    return axiosClient.post(`${REST_API_BASE_URL}/approve-decision`, formData)
}


export const updateDecisionRewardAndPenaltyEmployee = (list) => {
    const newList = list.map(({ id, ...rest }) => ({ ...rest }));
    return axiosClient.post(`${REST_API_BASE_URL}/reward-and-penalty-decision-employees`, newList)
}
